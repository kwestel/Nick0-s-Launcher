...
// URL : http://www.javaworld.com/javaworld/javaqa/2003-07/01-qa-0711-classsrc.html
//
...
// URL : http://www.javaworld.com/columns/jw-qna-index.shtml

public abstract class JRVME_ClassScope
{
    ...
    public static Class [] getLoadedClasses (final ClassLoader loader)
    {
        ...
        if (CLASSES_VECTOR_FIELD == null) throw new RuntimeException ("JRVME_ClassScope::getLoadedClasses() cannot be used in this JRE", CVF_FAILURE);
    ...
    {
        if (CALLER_RESOLVER == null) throw new RuntimeException ("JRVME_ClassScope::getCallerClassLoaderTree() cannot be used in this JRE", CR_FAILURE);
     ...
     * manager.
     */
    private static final class CallerResolver extends SecurityManager { protected Class [] getClassContext() { return super.getClassContext(); } }


    private JRVME_ClassScope() {} // this class is not extendible
    ...
    static
    {
        ...
        try
        {
            ...
            if ( tempf.getType () != Vector.class ) { throw new RuntimeException ("not of type java.util.Vector: " + tempf.getType ().getName ()); }
